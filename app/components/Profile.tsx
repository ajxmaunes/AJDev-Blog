...
export default function Profile() {
  return (
    <div className=' max-lg:mx-8'>
        <div className="flex flex-col items-center bg-white rounded-lg shadow md:flex-row max-w-[1070px] w-auto max-md:w-[21rem] border-[0.1px] border-gray-600">
            <img className="object-cover w-full rounded-t-lg h-96 lg:h-auto md:w-[350px] max-md:h-60 md:rounded-none md:rounded-s-lg" src="https://wallpapers.com/images/high/blogging-backdrop-with-laptop-msaf9d67o4r5dl74.webp" alt="" />
